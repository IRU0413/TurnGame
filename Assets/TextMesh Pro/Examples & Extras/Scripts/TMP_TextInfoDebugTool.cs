...
namespace TMPro.Examples
{
    ...
    public class TMP_TextInfoDebugTool : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // DrawRange line metrics
            #region Draw Lines
            if (ShowLines)
                DrawLineBounds();
            #endregion

            // DrawRange word metrics
            #region Draw Words
            if (ShowWords)
                DrawWordBounds();
            #endregion

            // DrawRange character metrics
            #region Draw Characters
            if (ShowCharacters)
                DrawCharactersBounds();
            #endregion

            // DrawRange Quads around each of the words
            #region Draw Links
            if (ShowLinks)
                DrawLinkBounds();
            #endregion

            // DrawRange Quad around the bounds of the text
            #region Draw Bounds
            if (ShowMeshBounds)
                DrawBounds();
            #endregion

            // DrawRange Quad around the rendered region of the text.
        ...
        void DrawCharactersBounds()
        {
            ...
            {
                // DrawRange visible as well as invisible characters
                ...
                // DrawRange Cap Height & Mean line
                ...
                // DrawRange text labels for metrics
            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //DebugPrint.LogPrint("Ready Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //DebugPrint.LogPrint("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //DebugPrint.LogPrint(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
        ...
        /// <summary>
        /// DrawRange rectangle around each of the links contained in the text.
        /// </summary>
        /// <param name="text"></param>
        void DrawLinkBounds()
        {
        ...
        /// <summary>
        /// DrawRange Rectangles around each lines of the text.
        /// </summary>
        /// <param name="text"></param>
        void DrawLineBounds()
        {
        ...
        /// <summary>
        /// DrawRange Rectangle around the bounds of the text object.
        /// </summary>
        void DrawBounds()
        {
