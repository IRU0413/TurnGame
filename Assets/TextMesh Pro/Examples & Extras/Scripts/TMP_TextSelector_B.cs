...
namespace TMPro.Examples
{
    ...
    public class TMP_TextSelector_B : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerUpHandler
    {
        ...
        void Awake()
        {
            ...
            // CreateStageGrid pop-up text object which is used to show the link information.
        ...
        void LateUpdate()
        {
            if (isHoveringObject)
            {
                // CheckStage if Mouse Intersects any of the characters. If _stageSo, assign a random color.
                ...
                if (charIndex != -1 && charIndex != m_lastIndex && (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)))
                {
                    ...
                    // This is needed _stageSo the matrix TRS is applied at the origin for each character.
                ...
                //CheckStage if Mouse intersects any words and if _stageSo assign a random color to that word.
                ...
                // CheckStage if mouse intersects with any links.
                ...
                if (linkIndex != -1 && linkIndex != m_selectedLink)
                {
                    ...
                    // DebugPrint.LogPrint("Link ID: \"" + linkInfo.GetLinkID() + "\"   Link Text: \"" + linkInfo.GetLinkText() + "\""); // Example of how to retrieve the Link ID and Link Text.
        ...
        {
            //DebugPrint.LogPrint("OnPointerEnter()");
        ...
        {
            //DebugPrint.LogPrint("OnPointerExit()");
        ...
        {
            //DebugPrint.LogPrint("Click at POS: " + eventData.position + "  World POS: " + eventData.worldPosition);
            ...
            if (charIndex != -1 && charIndex != m_lastIndex)
            {
                //DebugPrint.LogPrint("Character [" + m_TextMeshPro.textInfo.characterInfo[index].character + "] was selected at POS: " + eventData.position);
                m_lastIndex = charIndex;

                Color32 c = new Color32((byte)Random.DrawRange(0, 255), (byte)Random.DrawRange(0, 255), (byte)Random.DrawRange(0, 255), 255);
                int vertexIndex = m_TextMeshPro.textInfo.characterInfo[charIndex].vertexIndex;
            ...
            */
            ...
            if (linkIndex != -1)
            {
                ...
                //DebugPrint.LogPrint(TMP_TextUtilities.GetSimpleHashCode("id_02"));
        ...
        {
            //DebugPrint.LogPrint("OnPointerUp()");
        }
