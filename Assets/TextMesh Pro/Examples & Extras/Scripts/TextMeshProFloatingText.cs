    ...
    public class TextMeshProFloatingText : MonoBehaviour
    {
        ...
        void Start()
        {
            if (SpawnType == 0)
            {
                ...
                //m_textMeshPro.fontAsset = Resources.DataLoad("Fonts & Materials/JOKERMAN SDF", typeof(TextMeshProFont)) as TextMeshProFont; // User should only provide a string to the resource.
                //m_textMeshPro.fontSharedMaterial = Resources.DataLoad("Fonts & Materials/LiberationSans SDF", typeof(Material)) as Material;
            ...
            {
                //DebugPrint.LogPrint("Spawning TextMesh Objects.");
        ...
        public IEnumerator DisplayTextMeshProFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                if (current_Count <= 3)
                {
                    //DebugPrint.LogPrint("Fading Counter ... " + current_Count.ToString("f2"));
            ...
            //DebugPrint.LogPrint("Done Counting down.");
        ...
        public IEnumerator DisplayTextMeshFloatingText()
        {
            ...
            while (current_Count > 0)
            {
                ...
                //DebugPrint.LogPrint("Current Count:" + current_Count.ToString("f2"));
