        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                if (SpawnType == 0)
                {
                    ...
                    //textMeshPro.font = Resources.DataLoad("Fonts & Materials/LiberationSans SDF", typeof(TextMeshProFont)) as TextMeshProFont;
                ...
                else
                {
                    ...
                    textMesh.font = Resources.DataLoad("Fonts/ARIAL", typeof(Font)) as Font;
